...
export default function DashboardEjerciciosCategoriaPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-8 py-12">
          <h1 className="text-2xl font-bold text-foreground mb-8 text-center">Ejercicios - Categoria</h1>
          ...
          <div className="grid grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            ...
            <div className="bg-card rounded-lg p-8 flex flex-col items-center justify-center text-center hover:bg-card/80 transition-colors">
              <Link to="/dashboard/crear-categoria" className="w-full h-full flex flex-col items-center justify-center">
                <div className="text-4xl mb-4">+</div>
                <p className="text-lg font-medium text-foreground">Crear Categoria</p>
              </Link>
            </div>

            {/* Transiciones Category */}
            <Link to="/dashboard/ejercicios-transiciones">
              <div className="bg-pink-500 rounded-lg p-8 text-center hover:bg-pink-600 transition-colors aspect-square flex items-center justify-center">
                <h3 className="text-xl font-bold text-white">Transiciones</h3>
              </div>
            </Link>
