...
export default function DashboardEjercicios3vs7Page() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-8 py-12">
          <h1 className="text-2xl font-bold text-foreground mb-8 text-center">Ejercicios - Seleccionar Ejercicios Transiciones</h1>
          
          {/* Exercise Selection Grid */}
          <div className="grid grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            {/* Exercise Cards - showing selected exercises */}
