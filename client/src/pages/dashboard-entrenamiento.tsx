    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-8 py-12">
          <h1 className="text-2xl font-bold text-foreground mb-8 text-center">Entrenamiento</h1>
          ...
          <div className="grid grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link to="/dashboard/ejercicios">
              <div className="bg-card rounded-lg p-12 text-center hover:bg-card/80 transition-colors">
                <h2 className="text-xl font-medium text-foreground">Ejercicios</h2>
              </div>
            </Link>
            
            <Link to="/dashboard/planificacion-entrenamientos">
              <div className="bg-card rounded-lg p-12 text-center hover:bg-card/80 transition-colors">
                <h2 className="text-xl font-medium text-foreground">Planificacion de<br/>Entrenamientos</h2>
              </div>
            </Link>
          </div>
        </main>
